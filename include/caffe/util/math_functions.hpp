...
template <typename Dtype>
void caffe_gpu_add(const int N, const Dtype alpha, const Dtype* a, const Dtype beta, const Dtype* b, Dtype* y);
...
template <typename Dtype>
void caffe_gpu_add_mul(const int N, const Dtype* a, const Dtype* b, Dtype* y);
...
template <typename Dtype>
void box_filter_gpu(const int num, const int channels, const int height,const int width, const int radius, const Dtype *id, Dtype *od,Dtype * buffer);
