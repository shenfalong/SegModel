...
template <typename Dtype>
void ConvolutionLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top)
{
...
//----------------------------- work space ------------------------- 
	...
	col_buffer_ = static_cast<Blob<Dtype> *>(Caffe::parallel_workspace_[gpu_id_]);
 	bias_multiplier_ = static_cast<Blob<Dtype> *>(Caffe::parallel_workspace_[gpu_id_+Caffe::GPUs.size()]);
//----------------------------- ------------------------------------- 
