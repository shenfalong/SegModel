...
void ParamCuDNNConvolutionLayer<Dtype>::Forward_gpu( const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) 
{  
...
template <typename Dtype>
void ParamCuDNNConvolutionLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top, const vector<Blob<Dtype>*>& bottom) 
{  
	char * work_space0 = reinterpret_cast<char *>(myworkspace_[0]->mutable_gpu_data());
...
template <typename Dtype>
void ParamCuDNNConvolutionLayer<Dtype>::SecForward_gpu( const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) 
{
	char * work_space0 = reinterpret_cast<char *>(myworkspace_[0]->mutable_gpu_data());
	char * work_space1 = reinterpret_cast<char *>(myworkspace_[0]->mutable_gpu_diff());
	const int num = bottom[0]->num();
...
INSTANTIATE_LAYER_GPU_FUNCS(ParamCuDNNConvolutionLayer);
