...
//------------------------------------------------------------------------	
  ...
  buffer_top_ = static_cast<Blob<Dtype> *>(Caffe::parallel_workspace_[1*Caffe::GPUs.size()+gpu_id_]);
  bias_multiplier_ = static_cast<Blob<Dtype> *>(Caffe::parallel_workspace_[2*Caffe::GPUs.size()+gpu_id_]);
